<x-app-layout>
    ...
    <div class="mx-auto max-w-7xl" x-data="employees">
        ...
        <div class="my-2 grid grid-cols-3 gap-4 overflow-x-auto sm:rounded-lg" x-data="teachingSchedules">
            <x-card>
                ...
                <div class="mb-2">
                    ...
                    <x-text-input type="number" name="weight" x-model="weight" />
                </div>
                    ...
                    <table class="w-full table-auto">
                        <thead>
                            <tr>
                                ...
                                <th class="px-3 py-2 uppercase tracking-tight">Date</th>
                                <th class="px-3 py-2 uppercase tracking-tight">Weight</th>
                        ...
                        <tbody>
                            <template x-for="(sched, index) in schedules" :key="index">
                                <tr>
                                    ...
                                    <td class="px-2 py-1 text-center text-sm" x-text="sched.weight"></td>
                                    <td>
    ...
    function teachingSchedules() {
        return {
            ...
            editSchedule(sched) {
                ...
                this.end_date = sched.end_date
                this.selected_day = sched.day_of_week
                this.weight = sched.weight
            },
            cancelEdit() {
                this.clear()
            },
            saveSchedule() {
                if (this.is_editing) {
                    axios.put(`/teaching-schedules/${this.sched_for_editing}`, {
            ...
            getSchedules() {
                axios.get('/get-teaching-schedules', {
                    params: {
                        employee_id: this.employee.id,
                    }
                }).then(res => {
            ...
            deleteSchedule(id) {
                ...
                axios.delete(`/teaching-schedules/${id}`).then(response => {
                    this.getSchedules()
                }).catch(err => {
                    console.warn(err.response.data)
                })
