    ...
    function overtimes() {
        return {
            ...
            init() {
                ...
                const ot = @json($overtime);
                console.log(ot)
                this.overtime_id = ot.id
                this.start_time = ot.start_time
                this.end_time = ot.end_time
                this.effective_date = ot.date
                this.selectedEmployees = ot.employees
                this.reason = ot.reason
                this.overtime_type = ot.overtime_type_id
            ...
            saveOvertime() {
                axios.put('/overtimes/' + this.overtime_id, {
