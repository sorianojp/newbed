        ...
        <ul class="space-y-2 font-medium">
            ...
            <li x-data="{ open: {{ in_array(request()->route()->getName(), ['regular-schedules.index', 'teaching-schedules.index']) ? 'true' : 'false' }} }">
                <button @click="open = !open"
                    ...
                    <span class="ms-3 flex-1 text-left whitespace-nowrap">{{ __('Schedule') }}</span>
                ...
                <ul x-show="open" x-collapse class="pl-5 mt-1 space-y-1">
                    <li>
            ...
            <li x-data="{ open: {{ in_array(request()->route()->getName(), ['overtime-types.index', 'overtime-types.create', 'overtimes.index', 'overtimes.create']) ? 'true' : 'false' }} }">
                <button @click="open = !open"
                    ...
                    <span class="ms-3 flex-1 text-left whitespace-nowrap">{{ __('Overtime') }}</span>
                    <svg x-show="!open" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" class="w-4 h-4 ml-2">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
            ...
            <li x-data="{ open: {{ in_array(request()->route()->getName(), ['attendances.index', 'no-dtr.index', 'no-dtr.create']) ? 'true' : 'false' }} }">
                <button @click="open = !open"
                    ...
                    <span class="ms-3 flex-1 text-left whitespace-nowrap">{{ __('Attendance') }}</span>
                    <svg x-show="!open" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" class="w-4 h-4 ml-2">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
            ...
            <li x-data="{ open: {{ in_array(request()->route()->getName(), ['payroll-types.index', 'payroll-types.create', 'groupings.index', 'groupings.create']) ? 'true' : 'false' }} }">
                <button @click="open = !open"
                    class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                        class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
                    ...
                    <span class="ms-3 flex-1 text-left whitespace-nowrap">{{ __('Settings') }}</span>
                    <svg x-show="!open" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" class="w-4 h-4 ml-2">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                    </svg>
